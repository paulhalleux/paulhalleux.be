...
export default function Grid({children, className, responsive, gap, rows, cols}: GridProps) {
    const style = {
    ...
    return <div className={clsx(styles.grid, className)} style={style}>
        {children}
    </div>
}
...
function gap(gap: number | { col?: number; row?: number; }): gap is Gap {
